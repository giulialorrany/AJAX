...
**Conclusão pessoal:**  
O `async/await` ganhou facilmente pra mim. O código fica muito mais fácil de ler e entender, parece código síncrono. O `XMLHttpRequest` é bem mais trabalhoso. Em termos de desempenho, não senti diferença significativa — o que mais importa é a conexão com a internet.
